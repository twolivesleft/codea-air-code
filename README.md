...
For Mac and Linux platforms, libusbmuxd can be installed through Homebrew using `brew install libusbmuxd` (refer to [https://brew.sh/](https://brew.sh/) for Homebrew installation).
